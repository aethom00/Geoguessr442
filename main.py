...
def log_data(total_elapsed_time, total_epochs, epoch_per_epochs, images_per_epoch, loss, accuracy, folder='Logs'):
...
log_data(total_elapsed_time, total_epochs, epoch_per_epochs, images_per_epoch, loss, accuracy)
